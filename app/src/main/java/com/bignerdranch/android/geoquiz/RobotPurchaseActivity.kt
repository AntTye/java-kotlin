...
class RobotPurchaseActivity : ComponentActivity() {
    ...
    companion object {
        fun newIntent(packageContext: Context, robotEnergy_Red : Int, robotEnergy_White : Int, robotEnergy_Yellow : Int, robotTurn: Int): Intent {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reward_a.setOnClickListener     {
            makePurchase(1)
            val intent = MainActivity.newIntent(this, robotEnergy_Red, robotEnergy_White, robotEnergy_Yellow, robotTurn)
